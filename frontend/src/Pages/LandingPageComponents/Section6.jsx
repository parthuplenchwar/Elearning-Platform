  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Learner outcomes on <b style={{ color: "#0056d2" }}>PPU</b>
        </Text>
        <Text
          fontFamily={"poppins"}
          fontSize={{
